...
public class LegoClassifier
{
	 ...
	 */
	// TODO (obsolete) all of these generate functions need to be reworked so that they generate an ID that doesn't change if the order of the children changes
	...
	private void buildIDComponents(StringBuilder sb, Expression expression)
	{
		...
		{
			//TODO (obsolete) this is wrong - we also need to make the relgroup membership part of the ID.
			for (RelationGroup rg : expression.getRelationGroup())
			{
